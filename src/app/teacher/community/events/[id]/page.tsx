    ...
    if (!eventData) {
        return (
            <div className="max-w-3xl mx-auto py-24 text-center">
                ...
                <h2 className="text-xl font-bold">{t('teacher.community.eventNotFound')}</h2>
                <button onClick={() => router.back()} className="mt-4 text-indigo-500 font-bold hover:underline">{t('teacher.community.back')}</button>
            </div>
        )
    }
