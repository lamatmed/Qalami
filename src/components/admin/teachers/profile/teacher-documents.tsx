        ...
        fetchAdminDocumentsAction(teacherId).then(({ data }) => {
            setAdminDocs(prev => prev.map(d => {
                ...
                return {
                    ...
                    date: (() => { const _d = new Date(found.created_at); return _d.toLocaleDateString('fr-FR', { day: '2-digit', month: 'short', year: 'numeric', timeZone: 'Africa/Nouakchott' }) + ' ' + _d.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Nouakchott' }) })(),
